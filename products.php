  ...
  <div class="container mt-5 pt-4">
    ...
    <div class="row" data-aos="zoom-in-up" data-aos-offset="200">
        <div class="col-sm-12 col-md-4 col-lg-4 col-12">
            <div class="card">
              <div class="card-body">
                <img src="assets/blacksneaker.jpg" style="width: 400px;" class="img-fluid" alt="image">
                
                <p class="card-text ">Sports Shoes</p>
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-12">
             ...
             <div class="card ">
               <div class="card-body">
                <img src="assets/bluesneaker.jpg"style="width: 400px;" class="img-fluid" alt="image">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-12">
             <div class="card">
               <div class="card-body">
                <img src="assets/creamsneaker.jpg"style="width: 400px;" class="img-fluid" alt="image">
                <p class="card-text ">Sneakers</p>
                <a href="#" class="btn btn-dark">Buy Now</a>
              </div>
            </div>
     ...
     <div class="row mt-5" data-aos="zoom-in-down" data-aos-offset="200">
        <div class="col-sm-12 col-md-4 col-lg-4 col-12">
            <div class="card">
               <div class="card-body">
                <img src="assets/shoes.jpg"style="width: 400px;" class="img-fluid" alt="image">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-12">
             <div class="card">
              <div class="card-body">
                <img src="assets/sneakers.jpg"style="width: 400px;" class="img-fluid" alt="image">
                <p class="card-text ">Sneakers</p>
                <a href="#" class="btn btn-dark">Buy Now</a>
              </div>
            </div>
